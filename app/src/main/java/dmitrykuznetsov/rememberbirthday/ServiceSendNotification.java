...
//
//        String where="";
//        if (userCalendar.get(Calendar.DAY_OF_YEAR)==curCalendar.get(Calendar.DAY_OF_YEAR)) {
//
//        } else {
//            where=RememberContentProvider.DATE_BIRTHDAY_IN_SECONDS + "<=" + milliseconds;
//            Log.d("where", where);
...
//            Calendar curCalendar=Calendar.getInstance();
//            Calendar userCalendar=Calendar.getInstance();
//            userCalendar.setTimeInMillis(dateMillis);
//            String dateBirthday;
//            if (curCalendar.get(Calendar.DAY_OF_YEAR)==userCalendar.get(Calendar.DAY_OF_YEAR)) {
//                dateBirthday=" сегодня отмечает ДР";
//            } else {
//                dateBirthday=" "+ c.getString(c.getColumnIndex("date_birthday")) + " отмечал ДР";
//            }
