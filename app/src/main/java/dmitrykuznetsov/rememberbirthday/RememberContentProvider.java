...
public class RememberContentProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case ALLROWS: return "vnd.android.cursor.dir/vnd.dm.listpeople";
            case SINGLE_ROW: return "vnd.android.cursor.item/vnd.dm.listpeople";
    ...
    private static class FriendsBirthdayHelper extends SQLiteOpenHelper  {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w("LOG_TAG", "Обновление базы данных с " + oldVersion + " до версии " + newVersion + ", которое удалит старую базу данных");
